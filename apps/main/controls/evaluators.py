...
def aal_02_6_detail():
    ...
    return {
        ...
        'logic': (
            'Measured from Entra ID sign-in logs (last 30 days). A user passes if at least '
            'one of their sign-ins used a replay-resistant authenticator. '
